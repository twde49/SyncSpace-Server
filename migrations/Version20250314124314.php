 ...
 */
final class Version20250314124314 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_settings (id SERIAL NOT NULL, related_to_id INT NOT NULL, modules_layout JSON NOT NULL, theme VARCHAR(30) NOT NULL, notifications_enabled BOOLEAN NOT NULL, PRIMARY KEY(id))');
